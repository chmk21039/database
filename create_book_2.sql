...
DROP TABLE IF EXISTS public."貸出明細";
DROP TABLE IF EXISTS public."貸出";
DROP TABLE IF EXISTS public."書籍著者";
DROP TABLE IF EXISTS public."書籍";
DROP TABLE IF EXISTS public."著者";
DROP TABLE IF EXISTS public."出版社";
DROP TABLE IF EXISTS public."学生";
DROP DATABASE IF EXISTS book;
CREATE DATABASE book;
...
CREATE TABLE public."書籍" (
  ...
  "書籍名" TEXT NOT NULL,
  "出版社番号" INTEGER NOT NULL REFERENCES public."出版社"("出版社番号"),
...
CREATE TABLE public."書籍著者" (
  "ISBNコード" TEXT REFERENCES public."書籍"("ISBNコード"),
  "著者番号" INTEGER REFERENCES public."著者"("著者番号"),
  "役割" TEXT NOT NULL,
...
CREATE TABLE public."貸出" (
  ...
  "返却予定日" DATE NOT NULL,
  "返却確認日" DATE,
  "学生証番号" TEXT NOT NULL REFERENCES public."学生"("学生証番号")
);

CREATE TABLE public."貸出明細" (
  "貸出番号" INTEGER,
  "貸出連番" INTEGER,
  "ISBNコード" TEXT NOT NULL REFERENCES public."書籍"("ISBNコード"),
